...
while True:
    ...
    # 動態調整顯示區域
    roi_x, roi_y = img_width - 60, 0  # 右上角區域開始座標
    if roi_x + 60 <= img_width and roi_y + 60 <= img_height:
        img[roi_y:roi_y+60, roi_x:roi_x+60] = output
    ...
    # 顯示辨識結果
    cv2.putText(img, str(int(num)), (x, y-20), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255), 2, cv2.LINE_AA)
